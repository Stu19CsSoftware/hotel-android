...
import com.ranlychan.hotel.service.ExpenseService;
import com.ranlychan.hotel.service.GuestInfoService;
import com.ranlychan.hotel.service.OrderInfoService;
...
public class RoomOrderActivityMain extends BaseActivity {
    ...
    private void queryData() {
        roomTypeService.getRoomType(roomTypeObjId, new OnQueryRoomTypeListener() {
            @Override
            public void onQueryComplete(RoomType room) {
                roomType = room;
                initData();
            }
    ...
    private void initData(){
        ...
        tvRoomTypeShortIntro.setText(roomType.getShortIntro());
